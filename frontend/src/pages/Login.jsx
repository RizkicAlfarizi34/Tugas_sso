        ...
        <div className="text-white h-[100vh] flex justify-center items-center bg-cover" style={{ "background": "url('../src/assets/p4.jpg')" }}>
            <div className="bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
                ...
                <form action="">
                    ...
                    <button className="w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-black hover:bg-fuchsia-600 hover:text-white py-2 transition-colors duration-300" type="Submit">Login</button>
                    <div>
